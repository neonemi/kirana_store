...
class _CartScreenState extends State<CartScreen> {
        ...
        listener: (context, state) {
          ...
          if (state is CartOrderPlacedSuccess) {
            ...
            AlertExtension(context).showPaymentMethodDialog(
                onPayNow: () {
                  ...
                  _cubit.paymentPayload(
                      response.orderId.toString(), 'xyz', 'success');
          ...
          if (state is CartLoginError) {
            AlertExtension(context).showSuccessAlert(
                message: StringConstant.pleaseRegisterLogin,
                                  ...
                                  title: Text(StringConstant.itemTotal,
                                      style: TextStyle(
                                          ...
                                          fontFamily:
                                              StringConstant.fontFamily)),
                                  trailing: Text(
                                      '${StringConstant.rupeeSymbol}${cartController.cartTotalPrice()}',
                                      style: TextStyle(
                                          color: AppTheme.appBlack,
                                          fontSize: 14,
                                          fontStyle: FontStyle.normal,
                                  ...
                                  title: Text(StringConstant.gst,
                                      style: TextStyle(
                                          ...
                                          fontFamily:
                                              StringConstant.fontFamily)),
                                  trailing: Text(
                                      '${StringConstant.rupeeSymbol}${cartController.gstPrice()}',
                                      style: TextStyle(
                                          color: AppTheme.appBlack,
                                          fontSize: 14,
                                          fontStyle: FontStyle.normal,
                                  ...
                                  title: Text(StringConstant.deliveryCharge,
                                      style: TextStyle(
                                          ...
                                          fontFamily:
                                              StringConstant.fontFamily)),
                                  trailing: Text(
                                      '${StringConstant.rupeeSymbol}0.00',
                                      style: TextStyle(
                                          color: AppTheme.appBlack,
                                          fontSize: 14,
                                          fontStyle: FontStyle.normal,
                                  ...
                                  title: Text(StringConstant.grandTotal,
                                      style: TextStyle(
                                          ...
                                          fontFamily:
                                              StringConstant.fontFamily)),
                                  trailing: Text(
                                      '${StringConstant.rupeeSymbol}${cartController.grandTotalPrice(cartController.cartTotalPrice(), cartController.gstPrice())}',
                                      style: TextStyle(
                                          color: AppTheme.appBlack,
                                          fontSize: 14,
                                          fontWeight: FontWeight.w600,
                              ...
                              child: ListTile(
                                ...
                                onTap: () {
                                  _onTap(
                                      context,
                                      address,
                                      '${cartController.grandTotalPrice(cartController.cartTotalPrice(), cartController.gstPrice())}',
  ...
  void _onTap(BuildContext context, String currentLocation, String finalamount,
      String cartAmount, String coupon) {
  ...
  void _onApplyCoupon(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(
        builder: (BuildContext context) => const CouponScreen()));
  }
}
